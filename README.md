...
3. Deploy อัตโนมัติ
4. **ไฟล์ `vercel.json` จะจัดการ routing อัตโนมัติ**
...
5. **ไฟล์ `public/_redirects` จะจัดการ routing**

### การแก้ไขปัญหา 404 เมื่อ Refresh
หากเจอปัญหา 404 เมื่อ refresh หน้า ให้ตรวจสอบ:

1. **Vercel**: ไฟล์ `vercel.json` ต้องมีอยู่
2. **Netlify**: ไฟล์ `public/_redirects` ต้องมีอยู่
3. **Build**: รัน `npm run build` ก่อน deploy
4. **Cache**: ล้าง cache ของเบราว์เซอร์

### ไฟล์ที่สำคัญสำหรับ Deploy
- `vercel.json` - สำหรับ Vercel
- `public/_redirects` - สำหรับ Netlify
